...
namespace FHitReactTags
{
  	...
  	PROCHITREACT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HitReact_Profile_TakeShot);
  	PROCHITREACT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HitReact_Profile_TakeShot_NoArms);
